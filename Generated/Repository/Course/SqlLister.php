        ...
        try {
            ...
            return new CountedCourses(
                array_map(function ($array) {
                    return new Course((int)$array['id'], (string)$array['title'], (string)$array['slug'], (string)$array['imgUrl'], (string)$array['videoId'], (string)$array['description'], (int)$array['createdAt'], (bool)$array['isActive'], (int)$array['price']);
                }, $results),
                $count
            );
