...
class SqlByIdGetter implements ById
{
    ...
    public function byId(string $id): Episode
    {
        try {
            ...
            return new Episode((int)$result['id'], (string)$result['title'], (string)$result['slug'], (int)$result['courseId'], (string)$result['imgUrl'], (string)$result['description'], (string)$result['content'], (int)$result['createdAt'], (int)$result['position'], (bool)$result['isActive']);
