...
class SqlPatcher implements Patcher
{
    ...
    public function patch(string $id, PatchedEpisode $entity): Episode
    {
        ...
        $merged->getPosition(), $id);
          ...
          return new Episode($id, $merged->getTitle(),$merged->getSlug(),$merged->getCourseId(),$merged->getImgUrl(),$merged->getDescription(),$merged->getContent(),$byId->getCreatedAt(),$merged->getPosition());
