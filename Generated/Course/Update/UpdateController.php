<?php
    ...
    class UpdateController
    {
        ...
        {    
            try {
                $toUpdate = new UpdatedCourse($entity['title'] ?? '', $entity['invoiceTitle'] ?? '', $entity['content'] ?? '', $entity['slug'] ?? '', $entity['imgUrl'] ?? '', $entity['videoId'] ?? '', $entity['description'] ?? '', $entity['isFinished'] ?? false, $entity['price'] ?? 0, $entity['discount'] ?? 0);
