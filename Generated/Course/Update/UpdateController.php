<?php
    ...
    class UpdateController
    {
        ...
        {    
            try {
                $toUpdate = new UpdatedCourse($entity['title'] ?? '', $entity['content'] ?? '', $entity['slug'] ?? '', $entity['imgUrl'] ?? '', $entity['videoId'] ?? '', $entity['description'] ?? '', $entity['isActive'] ?? false, $entity['price'] ?? 0, $entity['discount'] ?? 0);
