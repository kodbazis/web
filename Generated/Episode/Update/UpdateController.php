<?php
    ...
    class UpdateController
    {
        ...
        {    
            try {
                $toUpdate = new UpdatedEpisode($entity['title'] ?? '', $entity['slug'] ?? '', $entity['courseId'] ?? 0, $entity['imgUrl'] ?? '', $entity['description'] ?? '', $entity['shortDescription'] ?? '', $entity['content'] ?? '', $entity['position'] ?? 0, $entity['isActive'] ?? false, $entity['isPreview'] ?? false);
