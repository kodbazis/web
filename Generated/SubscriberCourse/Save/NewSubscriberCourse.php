...
class NewSubscriberCourse implements JsonSerializable
{
...
public function __construct($subscriberId, $courseId, $name, $taxNumber, $zip, $city, $address, $purchaseType, $orderRef, $isPayed, $isVerified, $isInvoiceSent, $createdAt)
{
